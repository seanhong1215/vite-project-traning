...
function Pagination({ pagination, changePage }) {
    ...
    pagination: window.PropTypes.shape({
        total_pages: window.PropTypes.number,
        current_page: window.PropTypes.number,
        has_pre: window.PropTypes.bool,
        has_next: window.PropTypes.bool,
    }).isRequired,
    changePage: window.PropTypes.func.isRequired,
    };
